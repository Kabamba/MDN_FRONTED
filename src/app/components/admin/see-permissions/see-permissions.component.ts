...
@Component({
  selector: 'app-see-permissions',
  templateUrl: './see-permissions.component.html',
  styleUrls: ['./see-permissions.component.css']
})

export class SeePermissionsComponent implements OnInit{
  errors = {
    name: '',
    email: '',
    password: '',
