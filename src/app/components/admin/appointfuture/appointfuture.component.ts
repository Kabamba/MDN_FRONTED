...
@Component({
  selector: 'app-appointfuture',
  templateUrl: './appointfuture.component.html',
  styleUrls: ['./appointfuture.component.css'],
})
export class AppointfutureComponent implements OnInit {
  error = false;
